#!/usr/bin/env python3
"""
Generate HTML from summary markdown file using external CSS
"""
...
def generate_summary_html(markdown_file='Your_Genetic_Profile_Summary.md', 
                         output_file='output/Your_Genetic_Profile_Summary.html'):
    """Generate HTML from summary markdown file using external CSS"""
...
<head>
    ...
    <title>Your Genetic Profile - Summary</title>
...
if __name__ == '__main__':
    ...
    default_markdown = project_root / 'Your_Genetic_Profile_Summary.md'
    default_output = project_root / 'output' / 'Your_Genetic_Profile_Summary.html'
    
    markdown_file = sys.argv[1] if len(sys.argv) > 1 else str(default_markdown)
    output_file = sys.argv[2] if len(sys.argv) > 2 else str(default_output)
    
    generate_summary_html(markdown_file, output_file)
